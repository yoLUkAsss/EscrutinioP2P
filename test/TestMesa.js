...
contract('Mesa', function(accounts) {
  ...
  it("create a new Mesa with 2 candidates should create a Mesa with 2 candidates.", async () => {
    let mesaInstance = await Mesa.new(['c1', 'c2'], 1, fromObject)
  ...
  it("set fiscal should add 1 participant", async () => {
    let mesaInstance = await Mesa.new([], 1, fromObject)
